...
public final class ActionMode$CallbackC1778rz implements ActionMode.Callback {
    ...
    public ActionMode$CallbackC1778rz(ActionMode.Callback callback, TextView textView) {
        this.a = callback;
        this.b = textView;
    }
