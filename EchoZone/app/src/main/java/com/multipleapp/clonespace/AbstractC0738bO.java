...
public abstract class AbstractC0738bO {
    ...
    public static byte[] b(InputStream inputStream, int i) {
        ...
        while (i2 < i) {
            ...
            if (read >= 0) {
                ...
                throw new IllegalStateException(AbstractC1651px.n("Not enough bytes to read: ", i));
            }
        }
        return bArr;
    }
    ...
    */
    public static byte[] c(java.io.FileInputStream r8, int r9, int r10) {
        ...
        L8a:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.multipleapp.clonespace.AbstractC0738bO.c(java.io.FileInputStream, int, int):byte[]");
    }
