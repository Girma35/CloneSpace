...
/* renamed from: com.multipleapp.clonespace.hZ  reason: case insensitive filesystem */
/* loaded from: classes.dex */
public final class C1125hZ extends B {
    public static final Parcelable.Creator<C1125hZ> CREATOR = new XG(25);
    public final int a;
    public final int b;
    public final int c;
    public final int d;
    ...
    public C1125hZ(int i, int i2, int i3, int i4, int i5, int i6, boolean z, String str) {
        this.a = i;
        this.b = i2;
        this.c = i3;
        this.d = i4;
