...
public final class C0266Kp {
    ...
    public C0266Kp(ViewGroup viewGroup) {
        this.c = viewGroup;
    }
    ...
    public final boolean c(int i, int i2, int i3, int[] iArr, int[] iArr2) {
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        if (e instanceof InterfaceC0291Lp) {
            ((InterfaceC0291Lp) e).c(viewGroup, i, i2, iArr3, i3);
        } else if (i3 == 0) {
            try {
                FC.c(e, viewGroup, i, i2, iArr3);
            } catch (AbstractMethodError e2) {
    ...
    public final boolean d(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        if (this.d && (e = e(i5)) != null) {
            if (i == 0 && i2 == 0 && i3 == 0 && i4 == 0) {
                ...
                if (e instanceof InterfaceC0315Mp) {
                    ((InterfaceC0315Mp) e).d(viewGroup, i, i2, i3, i4, i5, iArr3);
                } else {
                    iArr3[0] = iArr3[0] + i3;
                    iArr3[1] = iArr3[1] + i4;
                    if (e instanceof InterfaceC0291Lp) {
                        ((InterfaceC0291Lp) e).e(viewGroup, i, i2, i3, i4, i5);
                    } else if (i5 == 0) {
                        try {
                            FC.d(e, viewGroup, i, i2, i3, i4);
                        } catch (AbstractMethodError e2) {
    ...
    public final boolean g(int i, int i2) {
        ...
        if (!f(i2)) {
            if (this.d) {
                ...
                View view2 = view;
                while (parent != null) {
                    boolean z = parent instanceof InterfaceC0291Lp;
                    if (z) {
                        f = ((InterfaceC0291Lp) parent).f(view2, view, i, i2);
                    } else {
                        if (i2 == 0) {
                            try {
                                f = FC.f(parent, view2, view, i);
                    ...
                    if (f) {
                        ...
                        if (z) {
                            ((InterfaceC0291Lp) parent).a(view2, view, i, i2);
                        } else if (i2 == 0) {
                            try {
                                FC.e(parent, view2, view, i);
                            } catch (AbstractMethodError e2) {
    ...
    public final void h(int i) {
        ViewParent e = e(i);
        if (e != null) {
            boolean z = e instanceof InterfaceC0291Lp;
            ViewGroup viewGroup = this.c;
            if (z) {
                ((InterfaceC0291Lp) e).b(viewGroup, i);
            } else if (i == 0) {
                try {
                    FC.g(e, viewGroup);
                } catch (AbstractMethodError e2) {
