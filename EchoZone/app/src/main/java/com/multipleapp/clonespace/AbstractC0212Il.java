...
public abstract /* synthetic */ class AbstractC0212Il {
    ...
    static {
        ...
        try {
            iArr[EnumC0237Jl.ON_STOP.ordinal()] = 2;
        } catch (NoSuchFieldError unused2) {
        }
        try {
            iArr[EnumC0237Jl.ON_START.ordinal()] = 3;
        ...
        try {
            iArr[EnumC0237Jl.ON_RESUME.ordinal()] = 5;
