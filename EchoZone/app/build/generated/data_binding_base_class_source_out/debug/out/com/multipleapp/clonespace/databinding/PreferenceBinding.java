...
public final class PreferenceBinding implements ViewBinding {
  ...
  private PreferenceBinding(@NonNull LinearLayout rootView, @NonNull PreferenceImageView icon,
  ...
  public static PreferenceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new PreferenceBinding((LinearLayout) rootView, icon, iconFrame, summary, title,
          widgetFrame);
    }
