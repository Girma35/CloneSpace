...
public class AlertDialogLayout extends AbstractC0824cm {
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L50:
            ...
            com.multipleapp.clonespace.bm r6 = (com.multipleapp.clonespace.C0762bm) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L73
            r7 = r2
        L73:
    ...
    public final void onMeasure(int i, int i2) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C2283R.id.topPanel) {
                    view = childAt;
                } else if (id == C2283R.id.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C2283R.id.contentPanel && id != C2283R.id.customPanel) || view3 != null) {
        ...
        if (mode2 != 1073741824) {
            ...
            while (i13 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c0762bm).width == -1) {
                        int i14 = ((LinearLayout.LayoutParams) c0762bm).height;
                        ((LinearLayout.LayoutParams) c0762bm).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i12, 0);
                        ((LinearLayout.LayoutParams) c0762bm).height = i14;
                    }
                }
                i13++;
