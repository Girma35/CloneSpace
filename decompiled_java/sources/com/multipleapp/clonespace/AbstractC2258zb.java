...
public abstract class AbstractC2258zb {
    ...
    public static final String b(InterfaceC1000fa interfaceC1000fa) {
        Object a2;
        if (interfaceC1000fa instanceof C1129hd) {
            return interfaceC1000fa.toString();
        }
        try {
            a2 = interfaceC1000fa + '@' + a(interfaceC1000fa);
        } catch (Throwable th) {
            a2 = TQ.a(th);
        }
        if (AbstractC0620Yu.a(a2) != null) {
            a2 = interfaceC1000fa.getClass().getName() + '@' + a(interfaceC1000fa);
        }
        return (String) a2;
    }
}
