...
/* renamed from: com.multipleapp.clonespace.xi  reason: case insensitive filesystem */
/* loaded from: classes.dex */
public abstract class AbstractC2139xi {
    ...
    public static int a(float f) {
        ...
        float[] fArr = c;
        return AbstractC2166y8.a(f3 * fArr[0], f2 * fArr[1], f5 * fArr[2]);
    }
