...
/* renamed from: com.multipleapp.clonespace.n0  reason: case insensitive filesystem */
/* loaded from: classes.dex */
public final class C1466n0 implements InterfaceMenuItemC1966uy {
    ...
    public final void c() {
        ...
        if (drawable != null) {
            if (this.n || this.o) {
                ...
                this.h = mutate;
                if (this.n) {
                    AbstractC2071wd.h(mutate, this.l);
                }
                if (this.o) {
                    AbstractC2071wd.i(this.h, this.m);
                }
            }
        }
    }
    ...
    public final MenuItem setIcon(int i) {
        this.h = AbstractC0750ba.b(this.i, i);
        c();
        return this;
    }
