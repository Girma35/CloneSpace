...
public final class C1334kv extends Drawable {
    public float a;
    ...
    public C1334kv(ColorStateList colorStateList, float f) {
        this.a = f;
    ...
    public final void b(Rect rect) {
        ...
        rect2.set(rect);
        if (this.f) {
            rect2.inset((int) Math.ceil(AbstractC1397lv.a(this.e, this.a, this.g)), (int) Math.ceil(AbstractC1397lv.b(this.e, this.a, this.g)));
            rectF.set(rect2);
        }
    }
