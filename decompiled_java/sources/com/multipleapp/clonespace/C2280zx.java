...
public final class C2280zx {
    ...
    public double h;
    public double i;
    public final C0691ae j;

    /* JADX WARN: Type inference failed for: r0v5, types: [java.lang.Object, com.multipleapp.clonespace.ae] */
    public C2280zx() {
    ...
    public final C0691ae c(double d, double d2, long j) {
        double sin;
        double cos;
        if (!this.c) {
        ...
        C0691ae c0691ae = this.j;
        c0691ae.a = (float) (sin + this.i);
        c0691ae.b = (float) cos;
        return c0691ae;
    }

    /* JADX WARN: Type inference failed for: r0v4, types: [java.lang.Object, com.multipleapp.clonespace.ae] */
    public C2280zx(float f) {
        this.a = Math.sqrt(1500.0d);
        this.b = 0.5d;
        this.c = false;
        this.j = new Object();
