...
public final class D6 {
    ...
    public /* synthetic */ D6(float f, float f2, float f3, float f4, float f5, float f6) {
        this.a = f;
        this.b = f2;
        this.c = f3;
        this.d = f4;
    ...
    public static D6 a(int i) {
        ...
        float pow;
        UC uc = UC.k;
        float b = AbstractC2139xi.b(Color.red(i));
        float b2 = AbstractC2139xi.b(Color.green(i));
        float b3 = AbstractC2139xi.b(Color.blue(i));
        float[][] fArr = AbstractC2139xi.d;
        float[] fArr2 = fArr[0];
        ...
        float f22 = uc.a;
        float f23 = uc.d;
        float pow5 = ((float) Math.pow(f21 / f22, uc.j * f23)) * 100.0f;
        ...
        float pow6 = ((float) Math.pow(1.64d - Math.pow(0.29d, uc.f), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((f * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * uc.e) * uc.c) * ((float) Math.sqrt((f15 * f15) + (f14 * f14)))) / (f17 + 0.305f), 0.9d)) * ((float) Math.sqrt(pow5 / 100.0d));
        Math.sqrt((pow * f23) / f24);
        float f25 = (1.7f * pow5) / ((0.007f * pow5) + 1.0f);
        float log = ((float) Math.log((uc.i * pow6 * 0.0228f) + 1.0f)) * 43.85965f;
        double d2 = f20;
        return new D6(f19, pow6, pow5, f25, log * ((float) Math.cos(d2)), log * ((float) Math.sin(d2)));
    }

    public static D6 b(float f, float f2, float f3) {
        UC uc;
        double d;
        float f4 = UC.k.d;
        Math.sqrt(f / 100.0d);
        Math.sqrt(((f2 / ((float) Math.sqrt(d))) * uc.d) / (uc.a + 4.0f));
        float f5 = (1.7f * f) / ((0.007f * f) + 1.0f);
        float log = ((float) Math.log((uc.i * f2 * 0.0228d) + 1.0d)) * 43.85965f;
        double d2 = (3.1415927f * f3) / 180.0f;
        return new D6(f3, f2, f, f5, log * ((float) Math.cos(d2)), log * ((float) Math.sin(d2)));
    }
    ...
    public int c(UC uc) {
        ...
        if (i != 0) {
            ...
            if (d != 0.0d) {
                ...
                float pow = (float) Math.pow(f / Math.pow(1.64d - Math.pow(0.29d, uc.f), 0.73d), 1.1111111111111112d);
                double d2 = (this.a * 3.1415927f) / 180.0f;
                float pow2 = uc.a * ((float) Math.pow(f3 / 100.0d, (1.0d / uc.d) / uc.j));
                float cos = ((float) (Math.cos(2.0d + d2) + 3.8d)) * 0.25f * 3846.1538f * uc.e * uc.c;
                float f4 = pow2 / uc.b;
                ...
                float max2 = (float) Math.max(0.0d, (Math.abs(f11) * 27.13d) / (400.0d - Math.abs(f11)));
                float[] fArr2 = uc.g;
                float f13 = pow3 / fArr2[0];
                float f14 = signum2 / fArr2[1];
                float signum3 = ((Math.signum(f11) * f12) * ((float) Math.pow(max2, 2.380952380952381d))) / fArr2[2];
                float[][] fArr3 = AbstractC2139xi.b;
                float[] fArr4 = fArr3[0];
                ...
                return AbstractC2166y8.a(f15, f17 + f16 + (fArr5[0] * f13), (signum3 * fArr[2]) + (f14 * fArr[1]) + f18);
            }
        }
        f = 0.0f;
        float pow4 = (float) Math.pow(f / Math.pow(1.64d - Math.pow(0.29d, uc.f), 0.73d), 1.1111111111111112d);
        double d22 = (this.a * 3.1415927f) / 180.0f;
        float pow22 = uc.a * ((float) Math.pow(f3 / 100.0d, (1.0d / uc.d) / uc.j));
        float cos3 = ((float) (Math.cos(2.0d + d22) + 3.8d)) * 0.25f * 3846.1538f * uc.e * uc.c;
        float f42 = pow22 / uc.b;
        ...
        float max3 = (float) Math.max(0.0d, (Math.abs(f92) * 27.13d) / (400.0d - Math.abs(f92)));
        float signum4 = Math.signum(f92);
        float f122 = 100.0f / uc.h;
        float pow32 = signum4 * f122 * ((float) Math.pow(max3, 2.380952380952381d));
        ...
        float max22 = (float) Math.max(0.0d, (Math.abs(f112) * 27.13d) / (400.0d - Math.abs(f112)));
        float[] fArr22 = uc.g;
        float f132 = pow32 / fArr22[0];
        float f142 = signum22 / fArr22[1];
        float signum32 = ((Math.signum(f112) * f122) * ((float) Math.pow(max22, 2.380952380952381d))) / fArr22[2];
        float[][] fArr32 = AbstractC2139xi.b;
        ...
        return AbstractC2166y8.a(f152, f172 + f162 + (fArr52[0] * f132), (signum32 * fArr[2]) + (f142 * fArr[1]) + f182);
    }
}
